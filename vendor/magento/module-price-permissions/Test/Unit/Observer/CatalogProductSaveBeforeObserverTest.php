...
class CatalogProductSaveBeforeObserverTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testCatalogProductSaveBefore()
    {
        ...
        $this->observerData = $this->getMockBuilder('Magento\PricePermissions\Observer\ObserverData')->setMethods(
            [
        ...
        $model = (new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this))
            ->getObject('Magento\PricePermissions\Observer\CatalogProductSaveBeforeObserver',
                [
