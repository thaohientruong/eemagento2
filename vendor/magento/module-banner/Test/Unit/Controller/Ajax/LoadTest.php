...
class LoadTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->requestMock = $this->getMockBuilder('Magento\Framework\App\Request\Http')
            ...
            ->getMock();
        $this->jsonFactoryMock = $this->getMockBuilder('Magento\Framework\Controller\Result\JsonFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->rawFactoryMock = $this->getMockBuilder('Magento\Framework\Controller\Result\RawFactory')
            ...
            ->disableOriginalConstructor()
            ->getMock();
        $this->dataFactoryMock = $this->getMockBuilder('Magento\Banner\Model\Banner\DataFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->dataMock = $this->getMockBuilder('Magento\Banner\Model\Banner\Data')
            ->disableOriginalConstructor()
            ->setMethods(['getSectionData'])
            ->getMock();
        $this->jsonMock = $this->getMockBuilder('Magento\Framework\Controller\Result\Json')
            ->setMethods(['setData'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testNonAjaxRequest()
    {
        ...
        $this->assertInstanceOf('Magento\Framework\Controller\Result\Raw', $this->object->execute());
    }
}
