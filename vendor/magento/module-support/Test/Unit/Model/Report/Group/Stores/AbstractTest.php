...
abstract class AbstractTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function prepareObjects($sectionClass)
    {
        ...
        $this->categoryCollectionFactoryMock = $this
            ->getMockBuilder('Magento\Catalog\Model\ResourceModel\Category\Collection\Factory')
            ->disableOriginalConstructor()
            ->getMock();
        $this->categoryCollectionMock = $this->getMockBuilder('Magento\Catalog\Model\ResourceModel\Category\Collection')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    protected function getStoreMock(array $data)
    {
        ...
        $storeMock = $this->getMockBuilder('Magento\Store\Model\Group')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    protected function getStoreViewMock(array $data)
    {
        ...
        $storeViewMock = $this->getMockBuilder('Magento\Store\Model\Store')
            ->disableOriginalConstructor()
