...
class CurlTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->loggerMock = $this->getMockBuilder('Magento\Payment\Model\Method\Logger')
            ...
            ->getMock();
        $this->responseFactoryMock = $this->getMockBuilder('Magento\Eway\Gateway\Http\Client\ResponseFactory')
            ->getMock();
        $this->curlMock = $this->getMockBuilder('Magento\Framework\HTTP\Adapter\Curl')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testPlaceRequestException()
    {
        ...
        $transferObjectMock = $this->getMockBuilder('Magento\Payment\Gateway\Http\TransferInterface')
            ->getMockForAbstractClass();
