...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$salesInstaller->getAttributesNumberInGroup($entityTypeId, $attributeSetId, 'Gift Options')) {
            $salesInstaller->removeAttributeGroup($entityTypeId, $attributeSetId, 'Gift Options');
        }
