...
class ControllersTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->collectionsFactoryMock = $this->getMock(
            'Magento\AdminGws\Model\ResourceModel\CollectionsFactory',
            ['create'],
            [],
            '',
            false
        );
        $this->collectionsMock = $this->getMock(
            'Magento\AdminGws\Model\ResourceModel\Collections',
    ...
    public function testValidateGiftCardAccount($isWebSiteLevel, $action, $id, $expectedInvoke)
    {
        $controllerMock = $this->getMock(
            'Magento\GiftCardAccount\Controller\Adminhtml\Giftcardaccount\Index',
    ...
    public function testValidateGiftregistryEntityAction(
        ...
        $recourceEntityMock = $this->getMock(
            'Magento\GiftRegistry\Model\ResourceModel\Entity',
        ...
        $this->_objectManager->expects(
            ...
            $this->equalTo('Magento\GiftRegistry\Model\Entity')
        )->will(
    ...
    public function testValidateCatalogProductReview($reviewId, $reviewStoreIds, $storeIds, $expectedRedirectInvoke)
    {
        ...
        $this->_objectManager->expects(
            ...
            $this->equalTo('Magento\Review\Model\Review')
        )->will(
    ...
    public function testValidateCatalogEvents(
        ...
        $categoryMock = $this->getMockForAbstractClass('Magento\Catalog\Api\Data\CategoryInterface', [], '', false);
    ...
    {
        $orderCreditmemoMock = $this->getMock(
    ...
    {
        $orderShipmentMock = $this->getMock(
    ...
    {
        $orderShipmentTrackMock = $this->getMock(
    ...
    {
        $checkoutAgreementMock = $this->getMock(
    ...
    {
        $controllerMock = $this->getMock(
            'Magento\Backend\Test\Unit\App\Action\Stub\ActionStub',
