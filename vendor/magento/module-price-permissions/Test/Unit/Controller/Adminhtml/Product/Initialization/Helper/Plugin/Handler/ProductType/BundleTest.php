...
class BundleTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        // @codingStandardsIgnoreStart
        $this->model = new \Magento\PricePermissions\Controller\Adminhtml\Product\Initialization\Helper\Plugin\Handler\ProductType\Bundle();
        // @codingStandardsIgnoreEnd
    }
    ...
    public function testHandleWithBundleOptions()
    {
        ...
        $selectionsMock = $helper->getCollectionMock('\Magento\Bundle\Model\ResourceModel\Selection\Collection', []);
        ...
        $collectionMock = $helper->getCollectionMock('\Magento\Bundle\Model\ResourceModel\Option\Collection', []);
