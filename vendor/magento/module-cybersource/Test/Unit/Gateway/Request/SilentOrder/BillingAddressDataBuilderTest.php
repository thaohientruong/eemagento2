 ...
 */
class BillingAddressDataBuilderTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $addressMock = $this->getMockBuilder('Magento\Payment\Gateway\Data\AddressAdapterInterface')
            ->getMockForAbstractClass();
