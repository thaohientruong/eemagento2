...
{
    /** @var  \Magento\Solr\Model\ResourceModel\Index|\PHPUnit_Framework_MockObject_MockObject */
    ...
    /** @var  \Magento\Solr\Helper\ClientOptionsInterface|\PHPUnit_Framework_MockObject_MockObject */
    ...
    protected function setUp()
    {
        ...
        $this->client = $this->getMockBuilder('Magento\Solr\Model\Client\Solarium')
            ...
            ->getMock();
        $this->clientHelper = $this->getMockBuilder('\Magento\Solr\Helper\ClientOptionsInterface')
            ->disableOriginalConstructor()
        ...
        $this->resourceIndex = $this->getMockBuilder('\Magento\Solr\Model\ResourceModel\Index')
            ->disableOriginalConstructor()
            ->getMock();
