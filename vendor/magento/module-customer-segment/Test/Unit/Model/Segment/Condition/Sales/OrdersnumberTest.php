 ...
 */
class OrdersnumberTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Ordersnumber
     */
    ...
    {
        $orderAdapter = $this->getMockForAbstractClass('Magento\Framework\DB\Adapter\AdapterInterface');
