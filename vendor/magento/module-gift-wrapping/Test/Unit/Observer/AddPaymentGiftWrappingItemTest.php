...
class AddPaymentGiftWrappingItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_model = $objectManagerHelper->getObject('Magento\GiftWrapping\Observer\AddPaymentGiftWrappingItem');
