...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->bannerValidatorMock = $this->getMockBuilder('Magento\Banner\Model\Banner\Validator')
            ->disableOriginalConstructor()
            ->setMethods(['prepareSaveData'])
            ->getMock();

        $this->saveController = $this->objectManager->getObject(
            'Magento\Banner\Controller\Adminhtml\Banner\Save',
            [
    ...
    public function testExecuteBannerNoExist()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ->method('addError')
            ->with(__('This banner does not exist.'))
            ->willReturnSelf();
    ...
    {
        $bannerMock = $this->getMockBuilder('Magento\Banner\Model\Banner')
            ->disableOriginalConstructor()
            ->getMock();

        $this->objectManagerMock->expects($this->any())
            ->method('create')
            ->with('Magento\Banner\Model\Banner')
    ...
    public function testExecuteWithLocalizedException()
    {
        ...
        $this->redirectMock->expects($this->once())
            ->method('setPath')
            ->with('adminhtml/*/edit', ['id' => $bannerId])
            ->willReturnSelf();
    ...
    public function testExecuteWithException()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ->method('addError')
            ->with(__('We cannot save the banner.'))
            ->willReturnSelf();
