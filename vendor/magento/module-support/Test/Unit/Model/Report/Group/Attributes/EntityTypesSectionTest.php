...
class EntityTypesSectionTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        $this->entityTypeCollectionFactoryMock = $this
            ->getMockBuilder('Magento\Eav\Model\ResourceModel\Entity\Type\CollectionFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->dataFormatterMock = $this->getMockBuilder('Magento\Support\Model\Report\Group\Attributes\DataFormatter')
            ->disableOriginalConstructor()
            ->getMock();

        $this->objectManagerHelper = new ObjectManagerHelper($this);
        $this->entityTypesSection = $this->objectManagerHelper->getObject(
            'Magento\Support\Model\Report\Group\Attributes\EntityTypesSection',
            [
    ...
    {
        $entityTypeCollectionMock = $this->getMockBuilder('Magento\Eav\Model\ResourceModel\Entity\Type\Collection')
            ->disableOriginalConstructor()
            ->getMock();
