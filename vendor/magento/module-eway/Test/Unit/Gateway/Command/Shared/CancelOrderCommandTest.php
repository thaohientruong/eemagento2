 ...
 */
class CancelOrderCommandTest extends \PHPUnit_Framework_TestCase
{
    const ORDER_ID = 10;
    ...
    protected function setUp()
    {
        ...
        $this->checkoutSessionMock = $this->getMockBuilder('Magento\Checkout\Model\Session')
            ...
            ->getMock();
        $this->resultFactoryMock = $this->getMockBuilder('Magento\Payment\Gateway\Command\Result\BoolResultFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
