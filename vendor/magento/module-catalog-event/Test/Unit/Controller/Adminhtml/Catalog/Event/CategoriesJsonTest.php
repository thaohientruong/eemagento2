...
class CategoriesJsonTest extends \Magento\CatalogEvent\Test\Unit\Controller\Adminhtml\Catalog\AbstractEventTest
{
    ...
    {
        $categoryBlockMock = $this->getMockBuilder('Magento\CatalogEvent\Block\Adminhtml\Event\Edit\Category')
        ...
        $this->layoutMock
            ->expects($this->once())
            ->method('createBlock')
            ->with('Magento\CatalogEvent\Block\Adminhtml\Event\Edit\Category')
