...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->postHelper = $this->getMockBuilder('Magento\Framework\Data\Helper\PostHelper')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    protected function prepareWishlist()
    {
        ...
        $this->itemCollection = $this->getMockBuilder('Magento\Wishlist\Model\ResourceModel\Item\Collection')
            ->disableOriginalConstructor()
            ->getMock();

        $this->itemCollectionFactory = $this->getMock(
    ...
    {
        $this->customerData = $this->getMockBuilder('Magento\Customer\Api\Data\CustomerInterface')
            ->getMockForAbstractClass();
