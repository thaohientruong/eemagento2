...
class ChooserTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $dataMock = $this->getMock('Magento\Backend\Helper\Data', [], [], '', false);
        $bannerColFactory = $this->getMockBuilder('Magento\Banner\Model\ResourceModel\Banner\CollectionFactory')
            ->disableOriginalConstructor()
            ->getMock();
        $bannerConfig = $this->getMock('Magento\Banner\Model\Config', [], [], '', false);

        $this->chooser = $this->getMockBuilder('Magento\Banner\Block\Adminhtml\Widget\Chooser')
    ...
    public function testPrepareElementHtml()
    {
        ...
        $formMock = $this->getMockForAbstractClass('Magento\Framework\Data\Form\AbstractForm', [], '', false);
        ...
        $hiddenMock = $this->getMock('Magento\Framework\Data\Form\Element\Hidden', [], [], '', false);
