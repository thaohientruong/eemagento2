...
class QtyCounterProxyTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->qtyCounter = $this->getMockBuilder('Magento\ScalableInventory\Model\ResourceModel\QtyCounter')
        ...
        $this->resource = $objectManager->getObject(
            'Magento\ScalableInventory\Model\ResourceModel\QtyCounterProxy',
            [
    ...
    public function testCorrectItemsQty()
    {
        ...
        $stockItem5269 = $this->getMockBuilder('Magento\CatalogInventory\Api\Data\StockItemInterface')
            ->disableOriginalConstructor()
            ->setMethods([
                'getBackorders',
        ...
        $stockItem9462 = $this->getMockBuilder('Magento\CatalogInventory\Api\Data\StockItemInterface')
            ->disableOriginalConstructor()
