...
class CategoryEavAttributesSectionTest extends AbstractTest
{
    protected function setUp()
    {
        parent::prepareObjects(
            'Magento\Support\Model\Report\Group\Attributes\CategoryEavAttributesSection'
        );
    }
    ...
    public function testGenerate()
    {
        ...
        $expectedResult = [
            (string)__('Category Eav Attributes') => [
                'headers' => [
