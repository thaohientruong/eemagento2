...
use Magento\Sales\Setup\SalesSetupFactory as SalesFactory;
use Magento\Quote\Setup\QuoteSetupFactory as QuoteFactory;
...
class InstallData implements InstallDataInterface
{
     ...
     * @param SalesFactory $salesSetupFactory
     * @param QuoteFactory $quoteSetupFactory
     */
    public function __construct(
        PageFactory $pageFactory,
        SalesFactory $salesSetupFactory,
        QuoteFactory $quoteSetupFactory
    ) {
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $quoteInstaller->addAttribute('quote', 'use_reward_points', ['type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER]);
