...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->helperData = $this->getMockBuilder('Magento\CustomerCustomAttributes\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();

        $this->helperCustomer = $this->getMockBuilder('Magento\CustomerCustomAttributes\Helper\Customer')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->entityType = $this->getMockBuilder('Magento\Eav\Model\Entity\Type')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $this->attribute = $this->getMockBuilder('Magento\Customer\Model\Attribute')
            ->disableOriginalConstructor()
            ->setMethods([
                'load',
                'save',
        ...
        $this->attributeFactory = $this->getMockBuilder('Magento\Customer\Model\AttributeFactory')
            ->disableOriginalConstructor()
            ->setMethods([
                'create',
            ])
        ...
        $this->attributeSetFactory = $this->getMockBuilder('Magento\Eav\Model\Entity\Attribute\SetFactory')
            ->disableOriginalConstructor()
            ->setMethods([
                'create',
            ])
