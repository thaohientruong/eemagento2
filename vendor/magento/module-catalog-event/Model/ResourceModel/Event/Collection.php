...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function addSortByStatus()
    {
        ...
        $columnExpr = $connection->quoteInto(
        ...
        $this->getSelect()->order(
            [
                $connection->getCheckSql($columnExpr, 0, 1) . ' ASC',
                $connection->getCheckSql($columnExpr, 'main_table.date_end', 'main_table.date_start') . ' ASC',
    ...
    {
        $connection = $this->getConnection();
        $timeNow = $this->localeDate->scopeDate(null, null, true);
