...
class RmaItemEavAttributesSectionTest extends AbstractTest
{
    ...
    {
        parent::prepareObjects('Magento\Support\Model\Report\Group\Attributes\RmaItemEavAttributesSection');
    }
        ...
        $data = [
            ...
            $this->createEntityAttributeMock(
                [
                    ...
                    'is_user_defined' => '0',
                    'source_model' => 'Magento\Rma\Model\Item\Attribute\Source\Status',
                    'backend_model' => '',
                    'frontend_model' => '',
                    'frontend_input' => 'select',
                    'backend_type' => 'static',
