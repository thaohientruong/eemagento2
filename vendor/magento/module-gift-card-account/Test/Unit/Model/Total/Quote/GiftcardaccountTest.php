...
class GiftcardaccountTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->giftCAHelperMock = $this->getMock('Magento\GiftCardAccount\Helper\Data', [], [], '', false);
        $this->giftCAFactory = $this->getMockBuilder('Magento\GiftCardAccount\Model\GiftcardaccountFactory')
