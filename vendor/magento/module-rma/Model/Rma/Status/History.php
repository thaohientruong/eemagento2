...
class History extends \Magento\Sales\Model\AbstractModel implements CommentInterface
{
    ...
    {
        return $this->getData(self::CUSTOMER_NOTIFIED);
    }
    ...
    {
        return $this->setData(self::CUSTOMER_NOTIFIED, $isCustomerNotified);
    }
    ...
    {
        return $this->getData(self::VISIBLE_ON_FRONT);
    }
    ...
    {
        return $this->setData(self::VISIBLE_ON_FRONT, $isVisibleOnFront);
    }
    ...
    {
        return $this->setData(self::ADMIN, $isAdmin);
    }
    ...
    {
        $this->_init('Magento\Rma\Model\ResourceModel\Rma\Status\History');
    }
