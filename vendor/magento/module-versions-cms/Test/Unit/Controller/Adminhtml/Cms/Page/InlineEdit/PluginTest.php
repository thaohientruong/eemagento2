...
class PluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->inlineEditController = $this->getMockBuilder('Magento\Cms\Controller\Adminhtml\Page\InlineEdit')
            ->disableOriginalConstructor()
            ->getMock();
        $this->nodeCollectionFactoryMock = $this->getMockBuilder(
            'Magento\VersionsCms\Model\ResourceModel\Hierarchy\Node\CollectionFactory'
        )->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->cmsPageCollectionFactoryMock = $this->getMockBuilder(
            ...
            ->setMethods(['create'])
            ->getMock();
        $this->cmsPageCollectionMock = $this->getMockBuilder('Magento\Cms\Model\ResourceModel\Page\Collection')
            ->disableOriginalConstructor()
            ->setMethods(['load', 'getItemById'])
            ->getMock();
        $this->nodeCollectionMock = $this->getMockBuilder(
            'Magento\VersionsCms\Model\ResourceModel\Hierarchy\Node\Collection'
        )->disableOriginalConstructor()
        ...
        $this->plugin = $this->objectManager->getObject(
            'Magento\VersionsCms\Controller\Adminhtml\Cms\Page\InlineEdit\Plugin',
            [
    ...
    public function testBeforeSetCmsPageDataWithDefaultPage()
    {
        ...
        $page0 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $page1 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $page2 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $page3 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $page404 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
    ...
    public function testBeforeSetCmsPageDataWithCustomPage()
    {
        ...
        $page2 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $page3 = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $yourNodePage = $this->getMock('Magento\Framework\DataObject', ['getData'], [], '', false);
        $this->cmsPageCollectionMock->expects($this->any())->method('getItemById')->willReturnMap(
            [
                ['36', $page0],
                ['33', $page1],
