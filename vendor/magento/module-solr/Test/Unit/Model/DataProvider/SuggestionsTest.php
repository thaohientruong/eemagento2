...
class SuggestionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->helperData = $this->getMockBuilder('Magento\Solr\Helper\Data')
        ...
        $this->connectionManager = $this->getMockBuilder('Magento\Solr\SearchAdapter\ConnectionManager')
            ->disableOriginalConstructor()
            ->getMock();
        $this->queryFactory = $this->getMockBuilder('Magento\Solr\Model\QueryFactory')
            ->disableOriginalConstructor()
            ->getMock();
        $this->accessPointMapper = $this->getMockBuilder('Magento\Solr\SearchAdapter\AccessPointMapperInterface')
            ->getMockForAbstractClass();
    ...
    public function testGetItems()
    {
        ...
        $spellCheck = $this->getMockBuilder('\Solarium\QueryType\Select\Query\Component\Spellcheck')
            ->setMethods(['setQuery', 'setCount', 'setExtendedResults'])
            ->disableOriginalConstructor()
            ->getMock();
        /** @var \PHPUnit_Framework_MockObject_MockObject $solariumSelect */
        $solariumSelect = $this->getMockBuilder('\Solarium\QueryType\Select\Query\Query')
        ...
        $searchQuery = $this->getMockBuilder('\Magento\Search\Model\QueryInterface')
            ->getMockForAbstractClass();
    ...
    private function getSpellcheckResultMock()
    {
        ...
        $this->connectionManager->expects($this->once())
            ...
            ->willReturn($client);
        $selectResult = $this->getMockBuilder('\Solarium\QueryType\Select\Result\Result')
        ...
        $spellCheckResult = $this->getMockBuilder('\Solarium\QueryType\Select\Result\Spellcheck\Result')
    ...
    {
        $result = $this->getMockBuilder('\Solarium\QueryType\Select\Result\Spellcheck\Suggestion')
            ->setMethods(['getWord'])
            ->disableOriginalConstructor()
            ->getMock();
