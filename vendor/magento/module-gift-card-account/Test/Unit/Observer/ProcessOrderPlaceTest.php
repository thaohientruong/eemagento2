...
class ProcessOrderPlaceTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->giftCAFactoryMock  = $this->getMockBuilder('Magento\GiftCardAccount\Model\GiftcardaccountFactory')
        ...
        $this->model = $objectManagerHelper->getObject(
            'Magento\GiftCardAccount\Observer\ProcessOrderPlace',
            [
    ...
    {
        $giftCardsQuote = is_array($giftCards) ? serialize($giftCards) : $giftCards;
