 ...
 */
class GetTransactionDataTest extends \PHPUnit_Framework_TestCase
{
    const ORDER_ID = 23;
    ...
    protected function setUp()
    {
        ...
        $this->placeTransactionServiceMock = $this->getMockBuilder('Magento\Worldpay\Model\Api\PlaceTransactionService')
            ->disableOriginalConstructor()
            ->getMock();
    }
