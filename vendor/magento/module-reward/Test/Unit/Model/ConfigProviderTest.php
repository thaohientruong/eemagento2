...
class ConfigProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->reward = $this->getMockBuilder('Magento\Reward\Model\Reward')
            ->disableOriginalConstructor()
            ->setMethods([
                'setCustomerId',
                'setWebsiteId',
        ...
        $this->rewardFactory = $this->getMockBuilder('Magento\Reward\Model\RewardFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->rewardHelper = $this->getMockBuilder('Magento\Reward\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->orderExtra = $this->getMockBuilder('Magento\Reward\Model\Action\OrderExtra')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testGetConfig(
        ...
        $this->reward->expects($this->any())
            ...
            ->with('Magento\Reward\Model\Action\OrderExtra', true)
