...
class PaginationTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->nodeFactoryMock = $this->getMock('Magento\VersionsCms\Model\Hierarchy\NodeFactory', [], [], '', false);
        ...
        $this->pagination = $this->objectManagerHelper->getObject(
            'Magento\VersionsCms\Block\Hierarchy\Pagination',
            [
    ...
    protected function getParentNodeChildren()
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $node = $this->getMock('Magento\VersionsCms\Model\Hierarchy\Node', [], [], '', false);
