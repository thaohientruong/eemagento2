...
abstract class Index extends \Magento\Backend\App\Action
{
    ...
    protected function _initData($useRedirects = true)
    {
        ...
        if (!$customer->getId()) {
            throw new InputException(__('We can\'t find this customer.'));
        }
        ...
        if ($storeId === null || $storeId == \Magento\Store\Model\Store::DEFAULT_STORE_ID) {
            ...
            if ($storeId && $useRedirects) {
                ...
                throw new InputException(__('We can\'t find this store.'));
            }
        } else {
    ...
    protected function _processException(\Exception $e)
    {
        if ($e instanceof LocalizedException) {
            ...
            $result = ['error' => __('Sorry, something went wrong. You can find out more in the error log.')];
        }
