...
class ConstraintProcessorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->constraintMock = $this->getMock('Magento\Framework\ForeignKey\ConstraintInterface', [], [], '', false);
        $this->constraintConnectionMock = $this->getMock(
        ...
        $this->strategyMock = $this->getMock('Magento\Framework\ForeignKey\StrategyInterface', [], [], '', false);
     ...
     * @expectedExceptionMessage Unknown strategy code: strategy
     */
