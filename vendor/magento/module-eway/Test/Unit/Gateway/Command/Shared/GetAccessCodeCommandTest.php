 ...
 */
class GetAccessCodeCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->validatorMock = $this->getMockBuilder('Magento\Payment\Gateway\Validator\ValidatorInterface')
            ->getMockForAbstractClass();
        $this->resultFactoryMock = $this->getMockBuilder('Magento\Payment\Gateway\Command\Result\ArrayResultFactory')
            ->setMethods(['create'])
    ...
    {
        $commandResultMock = $this->getMockBuilder('Magento\Payment\Gateway\Command\ResultInterface')
            ->getMockForAbstractClass();
