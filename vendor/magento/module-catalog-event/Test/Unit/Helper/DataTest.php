...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->contextMock = (new ObjectManager($this))->getObject('Magento\Framework\App\Helper\Context');
     ...
     * @param \PHPUnit_Framework_MockObject_Invocation $getImageUrlCalls
    ...
    {
        $eventMock = $this->getMock('Magento\CatalogEvent\Model\Event', ['getImage', 'getImageUrl'], [], '', false);
        $eventMock
            ->expects($this->once())
            ->method('getImage')
