...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->conditionManager = $this->getMockBuilder('Magento\Solr\SearchAdapter\ConditionManager')
        ...
        $rangeBuilder = $this->getMockBuilder('\Magento\Solr\SearchAdapter\Filter\Builder\Range')
        ...
        $termBuilder = $this->getMockBuilder('\Magento\Solr\SearchAdapter\Filter\Builder\Term')
            ->setMethods(['buildFilter'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->builder = $objectManager->getObject(
            'Magento\Solr\SearchAdapter\Filter\Builder',
            [
                'range' => $rangeBuilder,
                'term' => $termBuilder,
