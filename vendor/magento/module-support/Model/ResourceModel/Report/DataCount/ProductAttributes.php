...
class ProductAttributes
{
    ...
    public function getProductAttributesRowSizeForFlatTable()
    {
        ...
        $catalogEavAttributeTable = $this->catalogConnection->getTableName('catalog_eav_attribute');
        $eavAttributeTable = $this->catalogConnection->getTableName('eav_attribute');
        ...
        $description = $this->catalogConnection->describeTable($table);
