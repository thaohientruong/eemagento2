...
{
    /** @var \Magento\Support\Controller\Adminhtml\Backup\MassDelete */
    ...
    protected function setUp()
    {
        ...
        $this->massDeleteController = $this->objectManager->getObject(
            'Magento\Support\Controller\Adminhtml\Backup\MassDelete',
            [
    ...
    public function testSelectedDelete()
    {
        ...
        $this->objectManagerMock->expects($this->atLeastOnce())->method('get')->willReturnMap(
            [
                ['Magento\Support\Model\ResourceModel\Backup\Collection', $this->backupCollectionMock],
                ['Magento\Support\Model\Backup', $this->modelMock]
            ]
        );
