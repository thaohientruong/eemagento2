...
class WishlistEditorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->helper = $this->getMockBuilder('Magento\MultipleWishlist\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $this->wishlistCollection = $this->getMockBuilder('Magento\Wishlist\Model\ResourceModel\Wishlist\Collection')
            ->disableOriginalConstructor()
            ->getMock();
