 ...
 *
 * @method \Magento\GiftRegistry\Model\ResourceModel\Item _getResource()
 * @method \Magento\GiftRegistry\Model\ResourceModel\Item getResource()
    ...
    \Magento\Catalog\Model\Product\Configuration\Item\ItemInterface
{
    ...
    {
        $this->_init('Magento\GiftRegistry\Model\ResourceModel\Item');
    }
    ...
    public function addOption($option)
    {
        ...
        } elseif ($option instanceof \Magento\Framework\DataObject && !$option instanceof \Magento\GiftRegistry\Model\Item\Option) {
    ...
    public function getBuyRequest()
    {
        ...
        $buyRequest = new \Magento\Framework\DataObject($option ? unserialize($option->getValue()) : null);
