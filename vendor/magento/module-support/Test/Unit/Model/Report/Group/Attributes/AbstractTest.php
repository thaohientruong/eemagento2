...
abstract class AbstractTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->entityTypeFactoryMock = $this->getMockBuilder('Magento\Eav\Model\Entity\TypeFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->attributeCollectionFactoryMock = $this
            ->getMockBuilder('Magento\Eav\Model\ResourceModel\Entity\Attribute\CollectionFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
    ...
    {
        $entityAttributeCollectionMock = $this->getMock(
