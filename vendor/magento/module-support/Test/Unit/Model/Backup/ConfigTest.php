...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->config = $this->objectManagerHelper->getObject(
            'Magento\Support\Model\Backup\Config',
            [
    ...
    public function testGetBackupItems()
    {
        ...
        $itemDb = $this->getMock('Magento\Support\Model\Backup\Item\Db', ['setData'], [], '', false);
        $itemDb->expects($this->once())
            ->method('setData')
            ->with(['test' => 'test']);

        /** @var \Magento\Support\Model\Backup\Item\Code|\PHPUnit_Framework_MockObject_MockObject $item */
        $itemCode = $this->getMock('Magento\Support\Model\Backup\Item\Code', ['setData'], [], '', false);
