...
class ResultsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExecuteWithType()
    {
        ...
        $strategyMock = $this->getMockBuilder('Magento\MultipleWishlist\Model\Search\Strategy\Name')
            ->disableOriginalConstructor()
        ...
        $searchMock = $this->getMockBuilder('Magento\MultipleWishlist\Model\Search')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $collectionMock = $this->getMockBuilder('Magento\Wishlist\Model\ResourceModel\Wishlist\Collection')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $configMock = $this->getMockBuilder('Magento\Framework\View\Page\Config')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testExecuteWithEmail()
    {
        ...
        $strategyMock = $this->getMockBuilder('Magento\MultipleWishlist\Model\Search\Strategy\Email')
            ->disableOriginalConstructor()
            ->setMethods(['setSearchParams'])
            ->getMock();
