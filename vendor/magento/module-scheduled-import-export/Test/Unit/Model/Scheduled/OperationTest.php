...
class OperationTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->configScopeMock = $this->getMockBuilder('Magento\Framework\App\Config')
            ->disableOriginalConstructor()
            ->getMock();
        $this->stringStdLibMock = $this->getMockBuilder('Magento\Framework\Stdlib\StringUtils')
            ->disableOriginalConstructor()
            ->getMock();
        $this->transportBuilderMock = $this->getMockBuilder('Magento\Framework\Mail\Template\TransportBuilder')
            ...
            ->disableOriginalConstructor()
            ->getMock();
        $this->ftpMock = $this->getMockBuilder('Magento\Framework\Filesystem\Io\Ftp')
            ->disableOriginalConstructor()
            ->getMock();
        $this->resourceMock =
            $this->getMockBuilder('Magento\ScheduledImportExport\Model\ResourceModel\Scheduled\Operation')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testRun()
    {
        ...
        $operationInterfaceClass = 'Magento\ScheduledImportExport\Model\Scheduled\Operation\OperationInterface';
        $operationInterfaceMock = $this->getMockBuilder($operationInterfaceClass)
            ->setMethods([
                'getInstance',
                'setRunDate',
                'runSchedule',
        ...
        $operationInterfaceMock->expects($this->any())
            ->method('getInstance')
        ...
        $operationInterfaceMock->expects($this->once())
            ->method('runSchedule')
            ->will($this->returnValue(false));

        $this->genericFactoryMock->expects($this->any())
            ->method('create')
            ->will($this->returnValue($operationInterfaceMock));

        $writeInterfaceClass = '\Magento\Framework\Filesystem\Directory\WriteInterface';
        $writeInterfaceMock = $this->getMockBuilder($writeInterfaceClass)
            ->disableOriginalConstructor()
            ->getMock();

        $this->filesystemMock->expects($this->any())
            ->method('getDirectoryWrite')
            ->will($this->returnValue($writeInterfaceMock));
        ...
        $transportInterfaceMock = $this->getMockBuilder('\Magento\Framework\Mail\TransportInterface')
            ->disableOriginalConstructor()
            ->getMock();

        $this->transportBuilderMock->expects($this->any())
            ->method('getTransport')
            ->will($this->returnValue($transportInterfaceMock));
