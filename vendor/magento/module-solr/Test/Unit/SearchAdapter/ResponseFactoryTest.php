...
class ResponseFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->documentFactory = $this->getMockBuilder('Magento\Solr\SearchAdapter\DocumentFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();

        $this->aggregationFactory = $this->getMockBuilder('Magento\Solr\SearchAdapter\AggregationFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->factory = $helper->getObject(
            'Magento\Solr\SearchAdapter\ResponseFactory',
            [
