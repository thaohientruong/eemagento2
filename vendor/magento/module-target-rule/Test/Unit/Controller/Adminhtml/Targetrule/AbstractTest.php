...
abstract class AbstractTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->authorizationMock = $this->getMockBuilder('Magento\Framework\AuthorizationInterface')
            ->disableOriginalConstructor()
            ->getMock();
        $this->authMock = $this->getMockBuilder('Magento\Backend\Model\Auth')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->breadcrumbsBlockMock = $this->getMockBuilder('Magento\Framework\View\Element\BlockInterface')
            ->setMethods(['addLink', 'toHtml'])
            ->getMock();

        $this->menuBlockMock = $this->getMockBuilder('Magento\Framework\View\Element\BlockInterface')
