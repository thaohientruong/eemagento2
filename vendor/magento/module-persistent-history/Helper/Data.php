...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_WISHLIST, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_ORDERED_ITEMS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_COMPARE_PRODUCTS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_COMPARED_PRODUCTS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_VIEWED_PRODUCTS, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PERSIST_CUSTOMER_AND_SEGM, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
}
