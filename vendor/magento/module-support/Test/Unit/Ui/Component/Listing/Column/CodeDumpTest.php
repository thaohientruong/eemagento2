...
class CodeDumpTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->statusMock = $this->getMockBuilder('Magento\Support\Model\Backup\Status')
            ->disableOriginalConstructor()
            ->getMock();

        $this->itemCodeMock = $this->getMockBuilder('Magento\Support\Model\Backup\Item\Code')
            ->disableOriginalConstructor()
            ->getMock();

        $this->itemDbMock = $this->getMockBuilder('Magento\Support\Model\Backup\Item\Db')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->codeDump = $this->objectManager->getObject(
            'Magento\Support\Ui\Component\Listing\Column\CodeDump',
            [
