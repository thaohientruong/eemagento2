        ...
        return [
            CustomerDataBuilder::CUSTOMER => [
                self::CARD_DETAILS => [
                    ...
                    self::EXPIRY_MONTH => $this->formatMonth($payment->getCcExpMonth()),
                    self::EXPIRY_YEAR => $this->formatYear($payment->getCcExpYear()),
                    self::START_MONTH => $this->formatMonth($payment->getCcSsStartMonth()),
                    self::START_YEAR => $this->formatYear($payment->getCcSsStartYear()),
                    self::ISSUE_NUMBER => $payment->getCcSsIssue(),
