...
class GiftCardConfigProviderTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        $this->session = $this->getMockBuilder('Magento\Checkout\Model\Session')
            ...
            ->getMock();
        $this->management = $this->getMockBuilder('Magento\GiftCardAccount\Api\GiftCardAccountManagementInterface')
            ->getMock();
    ...
    public function testGetConfig()
    {
        ...
        $amount = 12.34;
        $giftCard = $this->getMockBuilder('Magento\GiftCardAccount\Api\Data\GiftCardAccountInterface')->getMock();
