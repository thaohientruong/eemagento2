...
use Magento\Support\Model\Report\Group\Modules\CustomModulesSection;

class CustomModulesSectionTest extends AbstractModulesSectionTest
{
    /**
     * {@inheritdoc}
     */
    public function generateDataProvider()
    {
        ...
        return [
            [
                'className' => 'Magento\Support\Model\Report\Group\Modules\CustomModulesSection',
                'dbVersions' => [
                    'schemaVersions' => [
                        ['Magento_Cms', '2.0.0']
                    ],
                ...
                'expectedResult' => [
                    CustomModulesSection::REPORT_TITLE => [
                        'headers' => $headers,
                        'data' => [
                            [
