...
class CronJobsTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cronConfigMock = $this->getMock('Magento\Cron\Model\ConfigInterface');
        $this->scopeConfigMock = $this->getMock('Magento\Framework\App\Config\ScopeConfigInterface');
        $this->directoryListMock = $this->getMock('Magento\Framework\Filesystem\DirectoryList', [], [], '', false);

        $this->cronJobs = $this->objectManagerHelper->getObject(
            'Magento\Support\Model\Report\Group\Cron\CronJobs',
            [
    ...
    {
        $cronJobs = [
            'clear_cache' => ['name' => 'clear_cache', 'instance' => 'Magento\Cache\ClearCache'],
            'custom_cron' => ['name' => 'custom_cron', 'instance' => 'Vendor\Module\Class'],
            'sitemap' => ['name' => 'sitemap', 'instance' => 'Magento\Sitemap\SitemapGenerator']
        ];
        ...
        return [
            ...
            [
                ...
                'expectedResult' => [
                    'clear_cache' => [
                        'name' => 'clear_cache',
                        'instance' => 'Magento\Cache\ClearCache'
                    ],
                    'sitemap' => [
                        'name' => 'sitemap',
                        'instance' => 'Magento\Sitemap\SitemapGenerator'
                    ]
                ]
            ],
            [
