...
class MysqlStatusSectionTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->resourceConnectionMock = $this->getMockBuilder('Magento\Framework\DB\Adapter\AdapterInterface')
