...
class HtmlTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dataConverterMock = $this->getMockBuilder('Magento\Support\Model\Report\DataConverter')
            ->disableOriginalConstructor()
            ->getMock();
        $this->htmlGeneratorMock = $this->getMockBuilder('Magento\Support\Model\Report\HtmlGenerator')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->exportHtmlBlock = $this->objectManagerHelper->getObject(
            'Magento\Support\Block\Adminhtml\Report\Export\Html',
            [
        ...
        $reportGroups = [
            'general' => [
                ...
                'sections' => [
                    ...
                    70 => 'Magento\Support\Model\Report\Group\General\CacheStatusSection',
                    80 => 'Magento\Support\Model\Report\Group\General\IndexStatusSection'
                ],
                'priority' => 10
            ]
        ];
        ...
        return [
            [
                'reportData' => [
                    ...
                    'Magento\Support\Model\Report\Group\Environment\MysqlStatusSection' => [
                        'MySQL Status' => []
                    ]
                ],
                'reportGroups' => [
                    ...
                    'environment' => [
                        ...
                        'sections' => [
                            ...
                            420 => 'Magento\Support\Model\Report\Group\Environment\MysqlStatusSection'
                        ],
                        'priority' => 30
                    ]
                ],
