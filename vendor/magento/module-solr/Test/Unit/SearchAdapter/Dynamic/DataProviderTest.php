...
class DataProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $filterQuery = $this->getMockBuilder('\Magento\Framework\Search\Request\Query\Filter')
            ->setMethods(['setQuery'])
        ...
        $fieldMapper = $this->getMockBuilder('Magento\Solr\SearchAdapter\FieldMapperInterface')
        ...
        $componentStats = $this->getMockBuilder('Solarium\QueryType\Select\Query\Component\Stats\Stats')
        ...
        $queryFactory = $this->getMockBuilder('Magento\Solr\SearchAdapter\QueryFactory')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $resultStats = $this->getMockBuilder('Solarium\QueryType\Select\Result\Stats\Stats')
        ...
        $resultSet = $this->getMockBuilder('Solarium\Core\Query\Result\ResultInterface')
            ->setMethods(['getStats'])
            ->disableOriginalConstructor()
        ...
        $client = $this->getMockBuilder('Magento\Solr\Model\Client\Solarium')
            ->setMethods(['query'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $entityStorage = $this->getMockBuilder('Magento\Framework\Search\Dynamic\EntityStorage')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $dataProvider = $this->objectManager->getObject(
            'Magento\Solr\SearchAdapter\Dynamic\DataProvider',
            [
    ...
    public function testGetInterval($entityIds, $mergedEntityIds)
    {
        ...
        $intervalFactory = $this->getMockBuilder('Magento\Framework\Search\Dynamic\IntervalFactory')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testGetRange()
    {
        ...
        $range = $this->getMockBuilder('Magento\Catalog\Model\Layer\Filter\Price\Range')
    ...
    {
        /** @var \Magento\Solr\SearchAdapter\Dynamic\DataProvider $dataProvider */
        $dataProvider = $this->objectManager->getObject('Magento\Solr\SearchAdapter\Dynamic\DataProvider');
    ...
    public function testGetAggregation()
    {
        ...
        $facetSet = $this->getMockBuilder('Solarium\QueryType\Select\Query\Component\FacetSet')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $facet = $this->getMockBuilder('\Solarium\QueryType\Select\Query\Component\Facet\Range')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $dimensionsBuilder = $this->getMockBuilder('\Magento\Solr\SearchAdapter\Dimensions')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    private function getConnectionManager($connectionManager, $query)
    {
        ...
        $facetSets = $this->getMockBuilder('Solarium\QueryType\Select\Result\FacetSet')
            ->disableOriginalConstructor()
            ->getMock();
