 ...
 */
class ProcessOrderPlaceObserverTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->checkStoreCreditBalance = $this
            ->getMockBuilder('Magento\CustomerBalance\Observer\CheckStoreCreditBalance')
            ->disableOriginalConstructor()
            ->getMock();

        $this->balance = $this->getMockBuilder('Magento\CustomerBalance\Model\Balance')
            ->disableOriginalConstructor()
            ->setMethods([
                'setCustomerId',
                'setWebsiteId',
        ...
        $this->balanceFactory = $this->getMockBuilder('Magento\CustomerBalance\Model\BalanceFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->model = $objectManagerHelper->getObject(
            'Magento\CustomerBalance\Observer\ProcessOrderPlaceObserver',
            [
