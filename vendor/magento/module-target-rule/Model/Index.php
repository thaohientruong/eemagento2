...
class Index extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Magento\TargetRule\Model\ResourceModel\Index');
    }

    /**
     * Retrieve resource instance
     *
     * @return \Magento\TargetRule\Model\ResourceModel\Index
     */
    ...
    public function getType()
    {
        ...
        if ($type === null) {
            throw new \Magento\Framework\Exception\LocalizedException(__('Undefined Catalog Product List Type'));
        }
        return $type;
    }
