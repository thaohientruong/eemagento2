...
class GiftwrappingAfterTax extends AbstractTotal
{
    ...
    public function collect(
        ...
        if (isset($extraTaxableDetails[Giftwrapping::ITEM_TYPE])) {
            $this->processWrappingForItems($total, $extraTaxableDetails[Giftwrapping::ITEM_TYPE]);
        }

        if (isset($extraTaxableDetails[Giftwrapping::QUOTE_TYPE])) {
            $this->processWrappingForQuote($total, $extraTaxableDetails[Giftwrapping::QUOTE_TYPE]);
        }

        if (isset($extraTaxableDetails[Giftwrapping::PRINTED_CARD_TYPE])) {
            $this->processPrintedCard($total, $extraTaxableDetails[Giftwrapping::PRINTED_CARD_TYPE]);
        }
    ...
    protected function processWrappingForItems($total, $itemTaxDetails)
    {
        ...
        $wrappingForItemsInclTax = 0;
        $baseWrappingForItemsInclTax = 0;
